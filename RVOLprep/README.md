...
Description: 'Imports the raw data from six cryptocurrencies, builds a price weighted portfolio from 
	      all of them and calculated log returns and realized volatility. Additionally, it gives 
    	      more information about the data with some graphs and descriptive statistics.' 
